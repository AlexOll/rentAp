...
namespace RentApp.Controllers
{
    ...
    public class OfferController : ApiController
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(List<Offer>), 200)]
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] Offer item)
        {
            if (item == null)
            {
                return BadRequest();
        ...
        {
            //AccommodationDetails det1 = new AccommodationDetails
            //{
            //    Floor = 2,
            //    Balcony = true,
            //    Terrace = false
            ...
            //    Lat = -37.765015,
            //    Lng = 145.133858,
            //    PropertyType = RealEstateType.Appartment,
            ...
            //{
            //    Price = 6666,
            //    ServiceType = OfferType.LTOfferRental,
